...
var scoreMax 		= 30; // total number of words the user must type
...
var currentLevel 	= 7;  // int representation of the current level, which determines which letter set to test
...
var myaudio = new Audio('key3.mp3');
var myaudio2 = new Audio('beep-07.wav');
...
function reset(){
	...
	for(let i = 1; i <=3 ; i++){
		...
		if(i == 1) {
			...
			//console.log(answerWordArray[0]);
			document.getElementById("wordMeaning").innerHTML = myMap.get(answerWordArray[0]);
			document.getElementById("wordMeaning2").innerHTML = myMap2.get(answerWordArray[0]);
			var wordaudio = new Audio('mp3/'+correctAnswer+'.mp3');
			wordaudio.play();
		}
	}
