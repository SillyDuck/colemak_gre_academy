var masterCSV = `word,meaning,ch_meaning
abacus,frame with balls for calculating       ,算盤
abate,to lessen to subside        ,緩和 減弱 減少 廢除緩和 減弱 減少
abdication,giving up control authority        ,遜位 棄權 辭職
aberration,straying away from what is normal      ,越軌 光行差 心理失常 色差
abet,help/encourage smb (in doing wrong)     ,教唆 幫助
abeyance,suspended action          ,中止 暫擱 停止
abhor,to hate to detest        ,憎惡 痛恨
abide,be faithful to endure        ,遵守 忍受 居留 堅持忍受
abjure,promise or swear to give up      ,發誓放棄
abrade,rubbed off worn away by friction      ,擦傷 磨損 磨
...
accolade,praise approval          ,武士爵位的授予 連譜號
accretion,the growing of separate things into one     ,增大 添加 添加物
adamant,kind of stone inflexible        ,堅硬的東西非常堅硬的
admonitory,containing warning          ,警告的 勸告的 訓誡的
adorn,add beauty decorate         ,裝飾 裝潢 使增色;佩戴 穿著
adulteration,making unpure poorer in quality       ,摻雜 摻假的東西 冒充貨
...
alcove,recess/partially enclosed place       ,凹室 壁櫥 小亭
allegiance,duty support loyalty         ,忠誠 忠貞
alleviate,make (pain) easier to bear       ,減輕 使緩和
alloy,to debase by mixing with something inferior     ,合金使成合金 攙以劣質 減低成色合鑄
...
antithetical,direct opposing          ,正相反的;對照的
apartheid,brutal racial discrimination         ,種族隔離
aplomb,self-confidence           ,沈著 泰然自若 垂直
apostate,one who abandons long-held religious or political convictions    ,背教者 變節者 脫黨者背教的 變節的 脫黨的
apotheosis,deification glorification to godliness        ,尊為神 封神 神化
appease,make quiet or calm        ,安撫 緩和 平息 滿足
apprehensive,grasping understanding fear unhappy feeling about future     ,憂慮的 不安的 擔心的 恐懼的;有理解力的 領悟的
apprise,give notice to inform        ,通知 報告 告知
approbation,approval           ,批准 贊成 認可;嘉獎 稱贊
apropos,appropriate to the situation apt       ,恰當 貼切 關於
apt,well-suited quick-witted          ,傾向於的 易於的 恰當的 聰明的
arabesque,a complex ornate design        ,阿拉伯式圖飾 蔓藤花紋
arboreal,of connected with trees        ,樹的 喬木的 棲於樹木的
ardor,enthusiasm           ,熱心 熱情
arduous,steep difficult ascent laborious        ,費力的 辛勤的 險峻的
argot,jargon slang          ,隱語 暗語 暗號
...
aseptic,surgically clean        ,防腐劑無菌的
asperity,roughness harshness ill temper irritability       ,粗暴 嚴酷 嚴寒
aspersion,slander           ,中傷 誹謗 污蔑
assail,with attack violently         ,攻擊 襲擊;著手解決
assiduous,diligent hard-working sedulous         ,勤勉的 刻苦的
assuage,make smth (pain desire) less       ,緩和 減輕 鎮定
asterisk,the mark * (e.g.. omitted letters)      ,星號
astringent,substance that shrinks         ,收斂劑收斂性的 嚴酷的 澀的
astute,clever quick at seeing to get an advantage    ,機敏的 狡猾的
atonement,repayment death of Jesus        ,贖回 償還 彌補
attenuate,make thin. weaken enervate        ,使變稀薄;使變細;弄淡
attune,bring into harmony       ,調音 使合調 使相合
audacious,daring foolishly bold impudent        ,大膽的 無禮的 無恥的
augury,omen sign          ,占兆 占卜 預言
...
avow,admit. Declare openly         ,聲明 承認 招認
baleful,harmful ominous causing evil        ,有害的 惡意的
balk,obstacle purposely to get on the way of    ,障礙 錯誤 失敗阻止 突然停止 退縮逡巡不前
baneful,causing harm or ruin pernicious destructive      ,有害的 使人苦惱的
barrage,artificial obstacle built across a river      ,掩護炮火 猛烈的炮火 連珠炮 彈幕 接二連三的射擊
barren,not good enough unable to have young ones without value  ,不育的 貧瘠的荒地
bask,in enjoy warmth and light       ,曬太陽 取暖 享受
beatify,to bless make happy or ascribe a virtue to   ,使享福 行宣福禮
bedizen,to adorn especially in a cheap showy manner    ,俗麗地穿著
belabor,beat hard        ,痛打
bellicose,belligerent pugnacious warlike         ,好戰的 好鬥的
belligerent,(person nation) waging war        ,好戰的 交戰的 交戰國的
benefactor,person who has given help       ,恩人 捐助者 贈送者
benevolence,wish or activity in doing good      ,善意 慈悲 善行
benign,kind and gentle mild (climate)       ,良性的
bequest,arrangement to give smth at death      ,遺贈物 遺產 遺贈
berate,scold sharply          ,嚴責
bereft,rob or dispossess of smth (material)      ,被剝奪的 喪失的 失去親人的
bewilder,puzzle confuse          ,使不知所措
bigot,stubborn narrow-minded person         ,盲信者 執拗的人 頑固者
bilge,bulge the protuberance of a cask      ,船底 船底的污水 污垢穿洞 使膨脹膨脹 船底漏水
blandishment,flattery coaxing          ,甜言蜜語 諂媚 奉承
blandness,polite manner comforting uninteresting        ,溫和;殷勤;爽快
blatant,noisy and rough         ,喧囂的 吵鬧的 俗麗的 炫耀的
blithe,cheerful casual carefree         ,愉快的 高興的
bogus,sham counterfeit not genuine        ,假的 偽造的
boisterous,loud noisy rough lacking restraint       ,猛烈的 喧鬧的 狂暴的
bolster,give greatly needed support        ,支援 長枕支援 支撐
boorish,crude offensive rude         ,粗野的 粗鄙的
...
buoyant,able to float light-hearted        ,有浮力的 心情愉快的
burgeon,grow forth send out buds       ,芽 嫩枝萌芽 發芽
burnish,to polish rub to a shine      ,磨 打磨 磨光磨光發亮光輝 光澤
cabal,a scheme or plot a group of plotters    ,徒黨 秘密結社 (尤指政治上的)陰謀策劃陰謀
cadge,to beg to get by begging      ,行乞 乞討 販賣
cajole,use flattery or deceit to persuade    ,以甜言蜜語哄騙 勾引
calipers,metal supports attached to the legs measuring instrument    ,彎腳器 測徑器
calumny,slander aspersion          ,誹謗 中傷
candid,frank straight-forward          ,坦白的 率直的 公正的
cant,insincere talk/jargon        ,偽善之言 黑話 斜面 角落講黑話 傾斜
cantankerous,bad-tempered/quarrelsome         ,心地不良的 愛吵架的
...
chary,cautious wary          ,細心的 吝嗇的 謹慎的
chasten,corrected punished          ,懲戒 抑制 磨練
chastisement,punishment           ,懲罰
chauvinist,a blindly devoted patriot        ,盲目的愛國者
chicanery,legal trickery/false argument       ,強詞奪理 狡辯 欺騙
chisel,steel tool for shaping materials       ,鑿子鑿 刻 雕鑿 欺騙
churl,bad-tempered person          ,下賤的人;吝嗇鬼;村夫
clamor,shout complain with a lot of noise     ,喧鬧 叫嚷 大聲的要求喧嚷 大聲的要求
clientele,customers         ,訴訟委託人 客戶
clinch,come to grips/settle conclusively      ,釘牢敲彎 扭住
cling,to resist separation         ,粘緊 附著 緊貼 堅持
clot,half-solid lump formed from liquid       ,凝塊 群(使)凝結 (使)聚集
cloture,closing device (in Parliament) to end a debate by voting  ,討論終結結束辯論
coagulation,change to a thick and solid state   ,凝結 凝結物
coalesce,coming together and uniting into one substance     ,合併 聯合 接合
coax,get smb to do smth by kindness     ,哄 誘騙 慢慢的做好哄騙哄騙
coda,passage that completes a piece of music   ,終結句 樂章結尾部 完結部
coddle,treat with care and tenderness       ,嬌養 溺愛 煮蛋嬌生慣養的人 寶貝子弟 嬌養小孩的人
coerce,compel to force to make obedient      ,強制 強迫
coeval,of the same period coexisting       ,同時代的同時代的人
cogent,strong convincing          ,使人首肯的 使人信服的 切實的
cogitate,think deeply mediate         ,思考 考慮
cognizant,being fully aware of        ,已認識 既知道 曉得
colander,bowl-shaped vessel with many holes used to drain off water  ,濾器 漏鍋
collusion,secret agreement for a deceitful purpose      ,勾結 共謀
...
conceit,over-high opinion of too much pride      ,自負 空想 狂妄
conciliatory,reconciling soothing comforting mollifying        ,安撫的 懷柔的 融和的
concord,agreement or harmony         ,一致 和睦 和睦的例子
concur,agree in opinion happen together       ,意見相同 一致 互助
condense,increase in density strength make laconic      ,使濃縮 摘要 縮短濃縮 凝結
condone,forgive           ,赦 寬恕
congeal,make or become stiff and solid      ,(使)凍結 (使)凝結
conjoin,to join together         ,(使)結合 (使)連結 (使)聯合
connoisseur,a person with good judgement (e.g.. in art)    ,鑒識家 鑒定家 內行
connotation,suggestion in addition to        ,含蓄 內涵
consequential,pompous self important         ,重要的 有意義的
console,give comfort or sympathy to       ,控制臺控制臺安慰 藉慰
conspicuous,easily seen remarkable         ,顯著的 顯眼的 出眾的
...
contiguous,touching neighboring near         ,毗鄰的 鄰近的 連接的
contrite,filled with deep sorrow for wrongdoing      ,悔悟了的 後悔的 痛悔的
contumacious,insubordinate rebellious          ,不聽命令的 頑固的 反抗法院命令的
conundrum,a riddle dilemma enigma        ,謎 難題 謎樣的人
conviction,convincing firm belief         ,定罪;確信 信服 信念
convoke,call together summon         ,召集
convoluted,complicated coiled twisted         ,旋繞的;迴旋狀的
cordial,warm and sincere         ,興奮劑 補品熱忱的 誠懇的 興奮的
...
countervail,counterbalance           ,補償 抵銷低銷
covert,disguised           ,隱蔽的 偷偷摸摸的 隱密的樹叢 隱藏處
covetous,eagerly desirous          ,妄羨的 亂要的 貪婪的
cower,crouch shrink back         ,畏縮 退縮 抖縮
coy,shy/modest (esp of a girl)     ,□腆的 怕羞的 羞怯的
crass,very great (es. stupidity)      ,粗魯的 愚鈍的 粗糙的 非常的
cravat,piece of linen worn as a necktie   ,領帶 圍巾 三角繃帶
craven,cowardly           ,懦夫 怯懦者 膽小鬼怯懦的 畏縮的 膽小的
crease,line made by crushing white line on the ground in cricket ,皺痕 折痕(使)起皺痕
credulity,too great a readiness to believe things     ,易信 輕信
credulous,ready to believe things        ,輕信的 易被瞞的 易受騙的
crush,press lose shape subdue overwhelm       ,壓碎 粉碎 群眾 迷戀壓破 征服 沖入 弄皺 擠入被壓碎 起皺 擠
...
daunt,intimidate make fearful         ,威嚇 難倒 使氣餒
dawdler,person who is slow waste of time     ,遊手好閑的人 懶人
dearth,shortage           ,缺乏 糧食不足 飢謹
debacle,a breakup overthrow sudden disaster       ,崩潰 潰裂
...
deluge,great flood heavy rush of water      ,大洪水 泛濫使泛濫
demagogue,person appealing not to reasons       ,煽動者 群眾煽動者
demur,to hesitate raise objections        ,提出異議 反對 抗辯異議 反對
denigrate,blacken belittle sully defame        ,使變黑 玷污 詆毀
denouement,an outcome or solution the unraveling of a plot   ,結局
deplete,use until none remains        ,耗盡 使衰竭
deposition,dethronement depositing          ,沈積作用 沈積物
deprave,make morally bad corrupt        ,使墮落 使惡化 使腐敗
deprecate,protest against express disapproval of       ,聲明不贊成 抨擊 反對
dereliction,deserting and leaving to fall into ruins     ,無主 拋棄物
derision,ridicule mockery deriding         ,嘲笑
derivative,unoriginal obtained from another source       ,引出的 系出的引出之物 系出物 衍生字
derogatory,insulting tending to damage        ,貶損的
descry,catch sight of see smth in the distance    ,看出 看見 察看
desiccant,substance used to absorb moisture       ,使乾燥的
desuetude,cessation of use disuse        ,廢止 不用
desultory,aimless haphazard digressing at random       ,散漫的 斷斷續續的 不連貫的
deter,discourage hinder          ,制止 使斷念 威懾
detraction,slandering verbal attack aspersion        ,誹謗;責難;毀損
detumescence,diminishing or lessening of swelling       ,消腫
deviance,being different in moral standards (from normal)     ,偏常，異常；異常行為
dexterity,skill (esp. in handling)        ,機巧 靈巧 機敏
diaphanous,transparent gauzy          ,透明的 精致的
...
discountenance,refuse to approve of        ,使丟臉 使蒙羞 使慌張不贊成 反對
...
disingenuous,sophisticated artful trying to deceive cunning      ,不老實的 不誠實的 虛偽的
disinter,dig up from the earth       ,掘出 發掘 顯露
dislodge,move force from the place occupied      ,逐出 使移動 驅逐離開原位
dismal,sad gloomy miserable         ,陰沈的 淒涼的 暗的低落的情緒 沼澤
disparate,essentially different          ,不同的 全異的 乖離的無法相比的東西
disproof,proof to the contrary      ,反証 反駁
dissemble,speak or behave so as to hide smth (in mind)  ,掩飾 假裝不知道
disseminate,distribute (esp. ideas)         ,散播 傳播 宣傳廣為傳播
dissent,have a different opinion refuse to assent     ,不同意 不同政見 異議
dissolution,disintegration looseness in morals        ,分解 溶解 解散 結束
distraught,distracted violently upset in mind       ,煩惱的 心痛的 發狂的
divergence,getting farther apart from a point      ,分歧
divestiture,taking off getting rid of giving up     ,剝奪;奪取;脫去
divulge,make known smth secret        ,泄露 暴露
doggerel,trivial poorly constructed verse        ,打油詩
dogmatic,positive certain arbitrary without room for discussion     ,教條的 獨斷的
dolt,stupid fellow          ,呆子 笨蛋 傻瓜
dormant,in a state of inactivity but awaiting development    ,睡眠狀態的 靜止的
dote,show much fondness center one's attention      ,溺愛;昏聵 智力衰退
drawl,slow way of speaking      ,懶洋洋地說 做作而慢慢地說懶洋洋的說話態度
droll,jesting         ,好笑的 滑稽的 逗趣的
drone,male bee person who isn't self-employed      ,雄蜂 懶惰者 嗡嗡的聲音 靶標嗡嗡作聲 混日子低沈地說出
drowsiness,feeling sleepy half asleep        ,睡意
dubious,feeling doubt          ,可疑的 不確定的
dud,no use person smth that fails      ,衣服 啞彈 無用物無用的
dulcet,melodious harmonious          ,優美的 美妙的 美味的 悅耳的
...
ebullient,overflowing with enthusiasm showing excitement       ,沸騰的 熱情的 熱情洋溢的
ecumenical,representing the whole Christian world       ,一般的;普通的
edacious,voracious devouring          ,貪吃的 狼吞虎咽的
eddy,circular or spiral movement (e.g.. of wind)     ,逆流 漩渦(使)起漩渦
...
elegy,a lament a melancholy composition       ,悲歌 哀歌 挽歌
elicit,draw out          ,引出 抽出 引起
eloquence,fluent speaking skillful use of language      ,口才 雄辯術 雄辯
emaciate,make thin and weak        ,使消瘦 使憔悴消瘦
embellish,make beautiful          ,修飾 裝飾 潤色
embezzle,use in a wrong way for one's own benefit   ,盜用 挪用
emote,stir up excite         ,誇張地作為 表現感情
empirical,relying on experiment         ,完全跟據經驗的 經驗主義的
encapsulate,enclose in capsule         ,裝入膠囊 封進內部 壓縮形成膠囊
encomium,warm or glowing praise eulogy panegyric      ,贊辭 稱贊 贊美
encumbrance,burden things that get on the way of    ,阻礙 妨害物 累贅
endearing,making dear or liked        ,引起愛情的 令人鐘愛的 可愛的
endemic,epidemic           ,地方病 風土病風土的 地方的
endorse,write one's name on the back of     ,背面簽字 背簽;簽署 批註 批准 贊成
enduring,lasting           ,持久的 不朽的
enervate,weaken deprive of strength attenuate       ,使衰弱衰弱的 無力的
engender,cause produce give rise to       ,產生 引起發生 形成
engrave,impress deeply          ,雕刻 鐫刻;牢記 銘記
engrossing,taken up all the time or attention writing in large or formal,繪制大型花飾字
engulf,swallow up          ,捲入 吸進 投入深淵 吞沒 使全神貫注
enigma,smth that is puzzling        ,謎 不可思議的東西
enmity,hatred being an enemy        ,敵意 憎恨
ensign,flag/badge         ,國旗 海軍少尉 掌旗官 徽章
entangle,put into difficulties         ,使糾纏 捲入 使混亂
enthral,please greatly/enslave (fig)       ,迷惑;迷醉;迷住;奴役
...
epitome,brief summary representative example a typical model     ,概要 縮影 概括
equable,steady regular          ,平靜的 變動小的
equanimity,calmness of temperament         ,平靜 鎮定 沈著
equilibrium,state of being balanced        ,平衡 均衡 均勢
equipoise,equal distribution of weight equilibrium       ,平衡 均衡使平衡 使相稱 使相持不下
equivocal,having a double or doubtful meaning suspicious     ,意義不明確的 模棱兩可的
equivocate,try to deceive by equivocal language      ,說模棱兩可的話 支吾
eradicate,get rid of pull up by the roots    ,根除 撲滅 根絕 消滅
erratic,irregular in behaviour or opinion       ,古怪的人 漂泊無定的人不穩定的 奇怪的
erudite,learned scholarly          ,博學的博學者
eschew,avoid         ,避開 遠避
esoteric,abstruse intended only for a small circle of    ,秘教的 奧秘的 秘傳的
espouse,marry give one's support to       ,信仰 信奉 擁護;嫁娶
eulogy,formal praise panegyric         ,贊詞 頌德文
euphoria,elation state of pleasant excitement       ,安樂感 陶醉 陶醉感
euthanasia,easy and painless death        ,安樂死
evasive,tending to evade       ,逃避的 回避的 托辭的
evince,to show clearly to indicate       ,表明 表示
...
extralegal,outside the law         ,不受法律支配的
extricable,that can be freed        ,可救出的 可解救的
extrovert,cheerful person          ,外向的人
exuberance,state of growing vigorously being full of life    ,茂盛 健康 豐富
facetious,humorous funny jocular         ,滑稽的 愛開玩笑的
facile,easily done          ,溫和的 容易的 靈巧的
fallacious,based on error         ,使人誤解的 謬誤的 不合理的
falter,waver/move in an uncertain manner     ,支吾地說 遲疑支吾 蹣跚地走顫抖 支吾 躊躇
fatuous,without sense foolish self-satisfaction        ,發呆的 愚笨的 自滿的
fawn,young deer try to win smb's favor     ,小鹿奉承 鬧著玩 撒嬌
feckless,lacking purpose or vitality ineffective careless      ,沒精神的 軟弱的 無用的
fecund,fertile           ,多產的 豐饒的 肥沃的
feint,pretend           ,偽裝 假裝 假託 佯攻裝作 假裝 佯攻假的 虛飾的
felicitous,apt suitably expressed well chosen apropos      ,巧妙的 極為適當的 可喜的
felon,person guilty of murder        ,重罪人 蛇頭 瘭疽
ferment,substance become excited         ,酵素 發酵 動亂(使)發酵 (使)動亂
ferocity,savage cruelty          ,兇猛 殘忍 狂暴的行為
ferret,discover by searching search        ,白鼬 雪貂 偵探 細帶用雪貂打獵 搜出 驅出搜索
fervid,showing earnest feeling         ,熱的 熱心的
fervor,warmth of feelings earnestness        ,熱情 熱心 熾熱
fetid,stinking         ,有惡臭的
fetter,to shackle put in chains       ,腳鐐 羈絆 束縛束縛 加腳鐐
feud,bitter quarrel over a long period of time    ,不和 封地 爭執長期不和 長期爭鬥
fidelity,loyalty accuracy          ,忠實 誠實 忠誠 保真度
fidget,move restlessly make nervous        ,慌張 急急忙忙 坐臥不安使煩亂 使不安急急忙忙 躊躇
figurehead,carved image on the prow of a ship    ,裝飾船頭的人像 破浪神 傀儡領袖
finesse,delicate way of dealing with a situation     ,精密技巧 靈巧 策略用計謀處理 出小牌
finical,too fussy about food clothing etc.      ,過分注意的 過分周到的 過分講究的
finicky,finical           ,過分注意的 過分周到的 過分講究的
fission,splitting or division (esp. of cells)      ,裂開 分裂 裂變
fixate,stare at          ,視線移向 注視使固定 注視
flak,criticism/anti-aircraft guns        ,高射炮 對空炮火廣告 宣傳
flamboyant,brightly colored florid         ,輝耀的 華麗的 火焰似的
flaunt,show off complacently         ,炫耀 飄揚炫耀 飄揚
flax,pale yellow (hair) a plant       ,亞麻 麻布 亞麻織品
fledge,able to fly trained experienced       ,喂養 用羽毛蓋上 裝上羽毛長羽毛
fleet,number of ships quick-moving        ,艦隊 港灣 小河 隊快速的 敏捷的 淺的淺疾馳 飛逝
flinch,draw move back wince        ,畏縮 退縮 畏首畏尾退縮 一種把牌堆積在桌上的遊戲
flop,fail/move/fall clumsily        ,砰然落下 拍擊聲 失敗笨重的摔 猛落笨拙地拋下噗通
florid,very much ornamented naturally red (e.g.. of face)    ,華麗的 紅潤的
flout,reject mock to go against (as in going against tradition)  ,嘲笑 愚弄表示輕蔑嘲笑 愚弄 輕視
fluke,lucky stroke        ,僥幸成功錨爪 比目魚 僥幸 倒楣
fluster,make nervous or confused        ,慌亂 狼狽 混亂 激動使酩醉 使慌張 使激動混亂
foible,defect of character (a person is wrongly proud)    ,弱點 缺點 自負的地方
foil,prevent from carrying out contrast       ,箔 烘托 襯托襯托 阻止 擋開 挫敗 貼箔於
foment,put smth warm (to lessen the pain)     ,熱罨 煽動
foolproof,incapable of failure or error     ,十分簡單明瞭的;十分安全的 極堅固的 有防備的
foppish,like a man who pays too much attention to his clothes ,浮華的 艷冶的 矯飾的 紈□的
forage,food for horses and cattle     ,糧草 飼料 搜尋糧草喂 掠奪 搜尋搜尋糧草 掠奪
forbear,refrain from be patient ancestor       ,忍耐 克制 容忍祖先
forbearance,patience willingness to wait        ,節制 自製 忍耐
ford,shallow place in a river (to cross)     ,淺灘涉過 涉水福特車
forestall,prevent by taking action in advance preempt     ,先…一步行動 佔先一步 壟斷 阻礙
forfeit,suffer the loss of smth       ,沒收物 罰金 喪失沒收 喪失喪失了的
forge,workshop for the shaping of metal to shape metal lead  ,熔爐 鐵工廠打制 鍛煉 偽造鍛造 偽造
forgery,counterfeit           ,偽造 偽造罪 偽造物
forswear,renounce disallow repudiate         ,發誓拋棄 發誓否定作偽証
foster,nurture care for         ,收養的 養育的養育 撫育 培養 鼓勵 抱(希望)
fracas,noisy quarrel        ,喧噪 吵鬧 紛擾
fragile,easily injured broken or destroyed       ,易碎的 脆的
fragrant,sweet-smelling           ,芬香的 馥鬱的 愉快的
frantic,wildly excited with joy pain anxiety      ,狂亂的 瘋狂的
frenetic,frantic frenzied          ,發狂的 狂熱的發狂者
fret,worry irritation wear away        ,煩躁 磨損 焦急 網狀飾物煩惱 不滿 磨損使煩惱 腐蝕 使磨損
fringe,edge ornamental border part of hair over the forehead   ,邊緣 端 流蘇 穗 初步加飾邊於邊緣的 附加的
froward,intractable not willing to yield or comply stubborn    ,頑固的 固執的 剛愎的
frugal,careful economical          ,節儉的 樸素的
fulmination,bitter protest          ,閃電 爆鳴 爆發
fulsome,disgusting offensive due to excessiveness       ,過度的 過分的 令人生厭的
gainsay,to deny to oppose,否認 否定;反對 反駁
garble,make unfair selection from facts     ,斷章取義 混淆
garment,article of clothing         ,衣服 衣裝 外表
garner,to gather and save to store up     ,穀倉 積蓄儲存 貯藏
garrulity,talkativeness           ,饒舌 多嘴
garrulous,too talkative          ,饒舌的 多嘴的 啁啾不休的
gaucherie,socially awkward tactless behavior        ,笨拙 粗魯 無禮
germane,relevant pertinent to         ,有密切關系的;適切的
gist,the point general sense        ,要點 要旨 依據
glean,gather facts in small quantities       ,拾落穗 收集
glib,ready and smooth but not sincere      ,能說善道的
glimmer,weak/unsteady light        ,一絲光線 微光發微光
gloat,over look at with selfish delight      ,滿足地看 獨自暗笑 貪婪地盯貪婪的盯視 滿足的注視 幸災樂禍
glut,supply to much fill to excess      ,大量 充斥 吃飽使充滿 使吃飽 過多供應狼吞虎咽
gnaw,waste away bite steadily        ,咬 啃 消耗 折磨 侵蝕
goad,smth urging a person to action      ,刺棒 激勵物 刺激物用刺棒驅趕 激勵 刺激 唆使 煽動
gorge,eat greedily/narrow opening with a stream    ,峽穀 飽食 咽喉狼吞虎咽塞飽
gossamer,soft light delicate material        ,小蜘蛛網 蛛絲 輕而弱者 薄紗薄弱的 輕飄飄的
gouge,tool for cutting grooves in wood      ,圓鑿 溝 以圓鑿刨用圓鑿子削除 挖出 欺騙
grandiloquent,using pompous words       ,誇張的 誇大的 浮誇的
grave,serious requiring consideration         ,墓穴 墳墓 雕刻工 抑音莊重的 嚴肅的 重大的 低沈的雕刻
graze,touch or scrape lightly in passing    ,吃草 放牧 擦傷 輕擦(使)吃草 放牧 輕擦 擦傷
gregarious,living in societies liking the company      ,社交的 群居的
grievous,causing grief or pain serious dire grave     ,痛苦的 嚴重的 充滿悲傷的
grovel,crawl humble oneself         ,趴 匍匐 卑躬屈膝
guile,deceit cunning          ,狡猾 狡計
...
harbinger,smth or smb that foretells the coming of    ,先行官 先驅 預兆預告 預示 作為…的先驅
harrow,to distress create stress or torment      ,耙 哈羅公學耙掘 傷害 使苦惱被耙松
haughty,arrogant conceited          ,傲慢的 驕傲的 不遜的
heed,attention/give notice to       ,注意 留心注意 留心
heinous,odious (of crime)         ,可憎的 極惡的
heresy,belief contrary to what is generally accepted     ,異端 異教
hermetic,sealed by fusion         ,密封的;煉金術的;神密的
heterogeneous,made up of different kinds       ,異種的 異質的 由不同成分形成的
hew,make by hard work cut (by striking)     ,砍 砍倒 砍成砍 劈 堅持
highbrow,(person) with superior tastes      ,知識分子 賣弄知識的人自炫博學的 知識分子的 不切實際的
...
hoodwink,trick mislead          ,遮眼 蒙蔽 欺騙
hospitable,liking to give hospitality        ,好客的 招待周到的
hubris,arrogant pride          ,傲慢 驕傲
hush,make or become silent      ,肅靜 安靜 沈默(使)肅靜 (使)安靜 (使)緘默
husk,worthless outside part of anything       ,外殼 皮 無價值之物剝…的殼 削皮
hypocrisy,falsely making oneself appear to be good     ,偽善
iconoclast,person who attacks popular beliefs       ,偶像破壞者 提倡打破舊習的人
idiosyncrasy,personal mannerism          ,特質 特性
idolatry,excessive admiration of         ,偶像崇拜 邪神崇拜 盲目的崇拜
idyll,a carefree episode or experience       ,田園詩;牧歌;田園文學.曲
ignoble,dishonorable common undignified         ,卑賤的 卑鄙的 不名譽的
ignominious,shameful dishonorable undignified disgraceful        ,可恥的 不名譽的 下流的
illicit,unlawful forbidden          ,不法的 不正的 禁止的
imbroglio,complicated and embarrassing situation        ,紛亂 糾葛 紛擾 一團糟
immaculate,pure faultless          ,無汙點的 純潔的 無瑕的 無缺點的 無辜的
imminent,likely to come or happen soon      ,即將來臨的 逼近的
immutable,that cannot be changed        ,不可變的 不變的 不能變的
impair,worsen diminish in value        ,損害 減少 削弱
impassive,unmoved feeling no sign of passion      ,無感情的 冷淡的 無感覺的 平靜的 不動的
impecunious,having little or no money       ,沒有錢的 身無分文的 貧窮的
impede,hinder get in the way of      ,妨礙 阻礙 阻止
impediment,smth that hinders (e.g. stammer)       ,妨礙 阻礙 阻止 口吃 行李
impending,imminent being about to happen expected      ,逼迫的 迫切的 懸空的
imperative,urgent essential          ,命令 誡命 需要 規則 祈使語氣命令式的 急需的 勢在必行的 強制的
imperious,commanding haughty arrogant         ,專橫的 傲慢的 迫切的
impermeable,that cannot be permeated        ,不能滲透的 不滲透性的
imperturbable,calm not capable of being excited      ,沈著的 泰然自若的 鎮靜的
impervious,not allowing to pass through (of materials)      ,透不過的 不滲透的 無動於衷的 不受影響的
impetuous,having sudden energy impulsive thrusting ahead forceful     ,沖動的 猛烈的 輕率的 急躁的
impiety,lack of reverence or dutifulness       ,無信仰 無信心 不虔誠 不孝
implacable,incapable of being placated unpleasable       ,難寬恕的 難和解的 執拗的
implicate,show that smb has a share      ,含意 暗示 牽連包含的東西
implicit,implied though not plainly expressed       ,暗示的 盲從的 含蓄的 固有的 絕對的
implosion,collapse bursting inward         ,[音聲] 內破裂
importune,beg urgently solicit (of a prostitute)      ,強求 硬要強求 糾纏
imprecation,an invocation of evil a curse      ,祈求 詛咒
impromptu,without preparation          ,即席演出 即興曲即席的即席
impudent,rash indiscreet          ,魯莽的 卑鄙的 厚顏無恥的
impugn,challenged to be doubted        ,責難 抨擊 攻擊
impute,to attribute to a cause or source ascribe    ,歸罪 使負責 嫁禍於
inadvertent,not paying proper attention        ,不注意的 怠慢的 不慎的 非故意的
inane,silly senseless          ,空虛的 愚蠢的 空洞的空洞無物
inasmuch,since because          ,因…之故 因為
incense,make angry          ,香 香氣 奉承焚香用香焚 使發怒
incessant,often repeated continual         ,不斷的 不絕的 無盡的
inchoate,not yet fully formed rudimentary elementary      ,剛開始的 早期的 未發達的
incipient,beginning         ,起初的 發端的 初期的
incise,engrave make a cut in       ,切割 雕刻
incite,stir up rouse         ,刺激 激勵 引誘
inclined,directing the mind in a certain direction     ,傾斜的
incongruous,out of place not in harmony or agreement    ,不協調的 不一致的 前後不一的
incorrigibility,cannot be cured or corrected       ,難望矯正
incredulous,skeptical unwilling to believe        ,懷疑的 不輕信的
inculcate,fix firmly by repetition        ,教授 諄諄教誨 教育
incumbent,official duties          ,憑依的 依靠的 負有義務的領聖職的俸祿的牧師 在職者
incursion,a raid a sudden attack       ,侵入 侵略 奇襲
indefatigability,not easily exhaustible tirelessness        ,不疲勞 不屈不撓
indelible,that cannot be rubbed out       ,不能消除的 不能拭除的 難忘的
indigence,poverty           ,貧乏 窮困
indigenous,native           ,本土的 土著的 國產的
indistinct,not easily heard seen clearly marked      ,不明了的 朦朧的
indolence,laziness           ,怠惰 不痛
indomitable,not easily discouraged or subdued       ,不屈服的 不屈不撓的
indulge,gratify give way to satisfy allow oneself     ,縱情於 放任 遷就沈溺
indulgent,inclined to indulge         ,縱容的 任性的 放縱的
ineffable,to great to be described in words     ,無法形容的 說不出的 不應說出的 避諱的
...
ingest,take in by swallowing        ,攝取 咽下
inimical,harmful or friendly         ,有敵意的 不友善的 抵觸的
inimitable,defying imitation unmatchable         ,無法仿效的 獨特的 無比的
innocuous,causing no harm         ,無害的 無毒的
inscrutable,incapable of being discovered or understood      ,難以瞭解的 不能預測的
insensible,unconscious unresponsive unaffected         ,不知的 昏迷的 無知覺的 冷淡的
insinuate,suggest unpleasantly make a way for smth gently    ,巴結 暗示 使潛入
insipid,without taste or flavor        ,沒有味道的 清淡的 難吃的
insouciant,unconcerned carefree          ,漫不經心的
insularity,narrow-mindedness isolated          ,島國 孤立 島國性質
insurrection,rising of people to open resistance to     ,叛亂 暴動 作亂
interdict,prohibit forbid          ,禁止 停止 制止禁令 禁止
interim,as an installment         ,中間的 暫時的 臨時的 間歇的中間時期 過渡時期 暫定
intersperse,place here and there        ,散佈 點綴
intransigence,unwillingness to compromise stubbornness intractability       ,不妥協;強硬
intransigent,uncompromising           ,非妥協性的不妥協的人
intrepid,fearless brave undaunted         ,無畏的 勇猛的 豪勇的
introspection,examining one's own thoughts and feelings      ,內省 反省
inundate,flood cover by overflowing        ,浸水 泛濫 淹沒 使充滿
inure,accustomed to adapted         ,使習慣生效
invective,abusive language curses         ,惡言漫罵 臭罵漫罵的 非難的 惡言的
inveigh,to attack verbally denounce deprecate       ,痛罵 漫罵 臭罵
inveterate,deep-rooted. long-established          ,根深的 成癖的 積習的
invincible,too strong to be defeated     ,不能征服的 無敵的
involute,complex           ,紛亂的 復雜的 內卷的漸開線內卷 恢復原狀 消失
irascible,irritable easily angered         ,易怒的 暴躁的
irate,angry           ,發怒的 生氣
ire,anger           ,忿怒
irksome,tiresome           ,厭惡的 討厭的 令人厭煩的
irresolute,hesitating undecided          ,無決斷的 優柔寡斷的 躊躇不定的
irrevocable,final and unalterable         ,不能挽回的 不能取消的 不能變更的
itinerate,to travel from place to place to peregrinate    ,巡迴 遊歷 巡迴傳教
jabber,talk excitedly utter rapidly        ,快而含糊地說 吱吱喳喳地叫 閑聊快而含糊不清的話
jibe,gibe make fun of        ,嘲笑 一致嘲笑嘲笑
jocular,meant as a joke        ,詼諧的
judicious,sound in judgment wise        ,頭腦精明的 賢明的 判斷正確的
knit,draw together unite firmly        ,編織 密接 結合
labyrinthine,to entangle the state of affairs      ,迷宮[似] 的
lachrymose,causing tears tearful         ,愛哭的 悲哀的
lackluster,(of eyes) dull         ,無光澤的;無神的
lament,show feel great sorrow        ,悲嘆 悔恨 慟哭 挽歌 悼詞哀悼悔恨 悲嘆
lassitude,weariness tiredness          ,疲倦 疲乏 無精神
latent,present but not yet active developed or visible    ,潛伏性的 隱藏的隱約的指印
laudatory,expressing or giving praise        ,贊美的 贊賞的
lavish,giving or producing freely liberally or generously     ,大方的 豐富的 浪費的浪費 濫用 慷慨給予
legacy,smth handed down from ancestors       ,祖先傳下來之物 遺贈物
levee,formal reception/embankment        ,早朝 大堤為…築堤
levity,lack of seriousness       ,輕率 輕浮 輕薄
libel,statement that damages reputation        ,以文字損害名譽 誹謗罪 侮辱誹謗 中傷 損害名譽
liberality,free giving generosity         ,慷慨;寬大;大方
libertine,immoral person          ,放蕩者 玩樂者 浪子 自由思想家放蕩的
lien,legal claim until a debt on it is repaid   ,留置權 優先權 抵押權
limn,paint portray          ,描寫 描繪
limp,lacking strength walking unevenly        ,跛行 一瘸一拐地走柔軟的 無生氣的
lionize,treat as a famous person     ,將…以名人待之 遊覽…的名勝結交名流
lithe,bending twisting          ,柔軟的
loll,rest to sit or stand in a lazy way hang (dog's tongue),懶散地閑蕩 垂下頭 伸舌垂 伸 靠著
lope,move along with long strides     ,(使)大步慢跑大步慢跑
loquacious,talkative garrulous          ,多嘴的 好辯的 吵鬧的 潺潺的
lucubrate,write in scholarly fashion        ,在燈下用功 深入研究 專心著作
luculent,easily understood lucid clear        ,光亮的 透明的
lugubrious,mournful excessively sad         ,可憐的 悲慘的 悲哀的
lull,become quiet or less active       ,暫停 間歇 稍息 麻痺使平靜 哄騙 使安靜變平靜
lumber,move in a clumsy/noisy way     ,木材 破舊家俱 廢物 隆隆聲砍伐木材 亂堆伐木 喧鬧地向前走
luminary,star light-giving body         ,發光體 權威者 著名的知識分子
lurk,be out of view ready to attack   ,潛伏 潛行潛藏 潛伏 埋伏
lustrous,being bright polished         ,有光澤的 光輝的
macabre,gruesome suggesting death         ,以死亡為主題的 可怕的
macerate,make or become soft by soaking in water  ,浸軟 消瘦把…浸軟 使消瘦
machination,plot scheme (esp. evil)        ,陰謀 圖謀 策劃
maladroit,tactless clumsy          ,笨拙的 拙劣的 愚鈍的
malapropism,misuse of a word (for one that resembles it)   ,文字誤用
malevolence,wishing to do evil        ,惡意 狠毒
malign,injurious speak ill of smb tell lie     ,有害的 惡性的 有惡意的誹謗 說壞話
malinger,to fake illness or injury in order to shirk a duty ,裝病 開小差
malleable,yielding easily shaped moldable adapting       ,有延展性的 可鍛的
manacle,chains for the hands or feet      ,手銬 束縛給…上手銬 束縛
massacre,cruel killing of a large number of people    ,大屠殺大屠殺 殘殺
matriculation,be admitted enter a university as a student    ,大學入學許可 入學 入學考試
maudlin,sentimental in a silly or tearful way     ,容易流淚的 感傷的 醉後好哭的易流淚
maul,hurt by rough handling      ,大槌打傷 虐打 粗暴對待
maverick,rebel nonconformist          ,未烙飼主印記的小牛 不服從的人迷路
mellifluous,sweetly flowing          ,甜美的;流暢的
mendacity,dishonesty           ,虛偽 謊話 說謊癖
mendicant,a beggar          ,行乞的 托缽的 化緣的乞丐 乞討 托缽僧
mercurial,quick changeable in character fleeting       ,Mercury神的 水星的 敏捷的 活潑的 水銀的水銀劑 汞劑
meretricious,attractive on the surface but of little value    ,華麗而庸俗的 俗氣的 娼妓的
mesmerize,hypnotize           ,施催眠術 迷住 迷惑
meticulous,giving great attention to details       ,一絲不苟的 精確的 過細的
mettle,quality of endurance or courage       ,勇氣 氣質 氣概
mettlesome,courageous high-spirited          ,精神蓬勃的;勇敢的
middling,fairly good but not very good      ,中等的 普通的 平凡的中等 相當地
minatory,menacing threatening          ,威脅的
mince,pronounce or speak affectedly euphemize       ,切碎物切碎 矯揉做作地說碎步走 裝腔作勢
misanthrope,person who hates mankind        ,厭惡人類的人 不願與人來往者
mischievous,harmful causing mischief         ,淘氣的 有害的 惡作劇的 胡攪的
miser,person who loves wealth and spends little     ,守財奴 吝嗇鬼 鑿井機
misogynist,one who hates women/females        ,厭惡女人的人
moderation,quality of being limited not extreme      ,緩和 適度 溫和
mollify,make calmer or quieter        ,平息 緩和 減輕 使鎮靜
molt,moult lose hair feathers before new growing     ,換毛 脫皮 換毛期脫毛 換毛
morbid,diseased unhealthy (e.g.. about ideas)       ,不健全的 病態的 疾病的 可怕的
morose,ill-tempered unsocial          ,鬱悶的 乖僻的
muffler,cloth worn round the neck/silencer     ,圍巾 頭巾 厚手套 消聲器
multifarious,varied motley greatly diversified        ,多種的 各種各樣的 繁雜的
mundane,worldly as opposed to spiritual commonplace everyday     ,現世的 世俗的 宇宙的
myriad,very great number         ,萬 無數 無數的人或物無數的 一萬的 種種的
nadir,lowest weakest point         ,天底 最底點 最低點
nascent,coming into existence emerging        ,發生中的 開始存在的 初期的
nebulous,cloud-like hazy vague indistinct        ,星雲的 星雲狀的 朦朧的
negligent,taking too little care        ,疏忽的 粗心的 不在意的
neophyte,person who has been converted to a belief    ,新入教者 新信徒
nexus,a connection tie or link       ,連結 關系
nibble,show some inclination to accept (an offer)     ,半字節半位元組 細咬 輕咬 啃一點一點地咬 細咬 吹毛求疵
noisome,offensive disgusting (smell)         ,有害的;有毒的;惡臭的
nonchalant,not having interest         ,漠不關心的 無動於衷的 若無其事的
nonplus,greatly surprised          ,使困惑迷惑 困惑 盡頭
nostrum,a quack remedy an untested cure      ,萬能藥 成藥 妙方
noxious,harmful           ,有害的 有毒的 精神不健全的
nugatory,trifling/worthless         ,無價值的 無用的 無效的 瑣碎的
obdurate,hardened and unrepenting stubborn inflexible       ,頑固的 執拗的 冷酷的
obfuscate,to darken make obscure muddle       ,弄暗 使模糊 使迷亂
oblivious,unaware having no memory        ,忘卻的 忘記的 健忘的 不注意的
...
occlude,blocked up          ,使閉塞 封閉 關閉 逐出咬合 臼合
odious,repulsive hateful          ,可憎的 可厭的 醜惡的
odium,contempt dislike aversion         ,憎惡 討厭 惡評
odor,smell favor reputation         ,氣味 味道;臭味 香味;香水;跡象 痕跡
officious,too eager or ready to help offer advice    ,多管閑事的 非官方的
ominous,threatening         ,惡兆的 不吉利的 預兆的
onerous,needing effort burdensome         ,繁重的 負有法律責任的
opaque,dullness/not allowing light to pass through    ,不透明物不透明的 不傳熱的
opprobrious,showing scorn or reproach        ,嘴不幹淨的 無禮的 粗野的
ossify,to turn to bone to settle rigidly into an idea  ,使骨化 使硬化骨化 硬化 變無情
ostensible,seeming appearing as such professed       ,表面的 假裝的
ostentation,display to obtain admiration or envy      ,虛飾 虛有其表 賣弄
ostracism,shut out from society refuse to meet talk    ,貝殼流放 放逐 排斥
overhaul,examine thoroughly to learn about the condition     ,分解檢查 翻修 精細檢查分解檢查 精細檢查 大檢修
overweening,presumptuously arrogant overbearing immoderate being a jerk     ,驕傲的 自負的 過于自信的
paean,song of praise or triumph       ,歡樂歌 贊美歌
palate,roof of the mouth sense of taste     ,上顎 味覺 趣味
palatial,magnificent           ,宏偉的 堂皇的 莊嚴的
palliate,lessen the severity of        ,減輕 緩和 辯解
palpability,can be felt touched understood       ,可觸知性 明白 明瞭
palpitate,tremble beat rapidly and irregularly       ,悸動 心跳 發抖
panegyric,formal praise eulogy         ,贊揚 誇大的頌詞 推崇備至
paradigm,a model example or pattern       ,範例 模範 詞形變化表
parenthesis,sentence within another one smth separated      ,括弧 插入語 附帶 插曲
pariah,an outcast a rejected and despised person     ,印度的最下階級 賤民 被放逐者
parsimonious,too economical miserly         ,節儉的;吝嗇的
partisan,one-sided committed to a party biased or prejudiced    ,黨羽 同黨的人 遊擊隊員黨徒的 效忠的 獻身的 盲目推崇的
patron,regular customer person who gives support      ,贊助人 顧客 保護人
paucity,scarcity a lacking of        ,少數 少量 缺乏
peccadillo,small sin small weakness in one's character     ,輕罪 小過 小暇疵
pedantic,bookish showing off learning        ,賣弄學問的 炫學者 假裝學者的
pedestrian,commonplace trite unremarkable         ,行人 步行者徒步的 呆板的 通俗的
pellucid,transparent easy to understand        ,透明的 澄清的 明瞭的
penchant,strong inclination a liking        ,傾向;嗜好;愛好
penitent,feeling or showing regret        ,懺悔的 悔悟的改過行善的人 懺悔的人 悔罪者
penurious,poor/stingy         ,貧窮的;缺乏的;吝嗇的
penury,extreme poverty          ,貧困 貧窮
peregrination,traveling about wandering         ,遊歷 旅行
peremptory,urgent imperative unchallengeable ending debate       ,斷然的 儼然的 強制的
perfidious,treacherous faithless          ,不誠實的 背信的 有異心的
perfidy,treachery breaking of faith        ,不誠實 背信
perfunctory,done as a duty without care      ,敷衍的 循例的 機械性的
perilous,dangerous           ,危險的
peripatetic,wandering           ,徒步的 逍遙學派的走來走去的人 遊歷 逍遙學派的學徒
perish,be destroyed decay         ,毀滅 死亡 腐爛毀壞 使麻木
perjury,willful FALSE statement unlawful act       ,偽誓 偽証
permeate,spread into every part of       ,彌漫 滲透 充滿透入
pernicious,harmful injurious          ,有害的 有毒的 致命的
perpetrate,be guilty commit (a crime)       ,做(惡) 犯(罪) 胡說
personable,pleasing in appearance attractive        ,風度好的 優雅的 貌美的
perspicacity,quick judging and understanding        ,聰穎 聰明 洞察力
pertain,belong as a part have reference      ,屬于 關於 附屬 適合 相稱
pest,destructive thing or a person who is nuisance    ,瘟疫 鼠疫;害蟲 害人蟲煩擾 糾纏
petrified,taken away power (to think feel act)     ,心膽俱裂
petrify,to make hard rocklike        ,使石化;使冷酷;使嚇呆
petrous,like a rock hard stony       ,岩石的 岩石般的 堅硬的
petulant,unreasonably impatient          ,暴躁的 易生氣的 難以取悅的
philistine,a smug ignorant person one who lacks knowledge    ,非利士人 仇敵 俗氣的人非利士的 俗氣的 無教養的
phlegmatic,calm sluggish temperament unemotional        ,粘液質的;冷漠的
picaresque,involving clever rogues or adventurers       ,以歹徒為題材的歹徒
pied,of mixed colors         ,斑駁的 雜色的 花衣服的
pinch,be too tight take between the thumb and finger   ,捏 撮 收縮 壓力 匱乏 緊急關頭掐 夾痛 修剪 使困苦 使萎縮
pine,waste away through sorrow or illness    ,松樹消瘦 憔悴 渴望   ;   (unix操作系統下的一種信件處理程式)
pious,dutiful to parents devoted to religion      ,虔誠的
piquant,agreeably pungent stimulating         ,辛辣的 開胃的 活潑的 痛快的 調皮的 淘氣的
pique,hurt the pride or self-respect stir (curiosity)     ,生氣 憤怒傷害…自尊心 激怒 刺激
pitfall,covered hole as a trap unsuspected danger     ,陷阱 誘惑 陰謀
pith,essential part force soft liquid substance      ,木髓 骨髓 核心 意義 精華除去木髓 殺死
pivotal,of great importance (others depend on it)     ,樞軸的 關鍵的
placate,soothe pacify calm         ,撫慰 使和解 懷柔
plaintive,mournful melancholy sorrowful         ,悲哀的 哀傷的
plaque,flat metal on a wall as a memorial    ,匾 飾板 名牌 血小板
platitude,a trite or banal statement unoriginality      ,單調 平凡 陳腐
plea,request           ,懇求 辯解 抗辯 請願 托詞
plead,address a court of law as an advocate    ,辯護 懇求為…辯護 托稱
plethora,glut           ,過多 過剩 多血症
pliant,pliable easily bent shaped or twisted      ,易曲折的 柔軟的 柔順的
plod,continue doing smth without resting       ,沈重的步伐 辛勤工作沈重地走 辛勤工作 孜孜從事沈重緩慢地走
pluck,pull the feathers off pick (e.g.. flowers)     ,勇氣 猛拉 動物內臟摘 猛拉 拔 拉 扯 采 拆毀拉 拽
plumb,get to the root of       ,鉛錘 垂直垂直的使垂直 用鉛封 探測 瞭解垂直
plummet,fall plunge steeply         ,鉛錘 鉛錘線垂直落下
plunge,move quickly suddenly and with force      ,鑽進 跳進 跳水 跳水池 落下 下跌 投入 盲目投資投入 跳進 陷入
poignant,deeply moving keen         ,嚴厲的 尖銳的 劇烈的
poncho,large piece of cloth      ,南美人穿的寬大的外衣 斗篷 雨披
ponderous,heavy bulky dull         ,沈重的 笨重的 冗長的 沈悶的
portent,omen marvelous threatening         ,前兆 預示 異常之物
precarious,uncertain risky dangerous         ,不穩定的 不安的 危險的
precept,rules establishing standards of conduct       ,教訓 告誡 訓誡 方案 命令書
preclude,prevent make impossible         ,預先排除 預防 阻止 妨礙
precursory,preliminary anticipating          ,先驅的 前兆的 作預備的
predilection,special liking mental preference        ,嗜好 偏愛 袒護
predominate,have more power than others       ,掌握 控制 支配統治 成為主流
preen,tidy/show self-satisfaction        ,用嘴理 打扮 贊揚打扮漂亮 自負
premature,doing or happening smth before the right time    ,早熟的 過早的 不按時的早產兒 早發
preponderance,greatness in number strength weight       ,重量的優勢 優勢 優越
presage,warning sign          ,預感 預兆 預知成為…的前兆 預示 預言預言
presumption,arrogance         ,專橫 放肆 假定 推測 可能性
preternatural,not normal or usual        ,超自然的 異常的 奇異的
prevalent,common           ,普遍的 流行的
prevaricate,to equivocate to stray from the truth     ,支吾其辭 搪塞 撒謊
prim,neat formal          ,規規矩矩的 呆板的 拘謹的弄整齊 把嘴閉緊一本正經
pristine,primitive unspoiled pure as in earlier times unadulterated    ,原來的 古時的 原始的
probity,uprightness incorruptibility principle         ,誠實 廉潔 正直
proclivity,inclination           ,傾向 癖性 氣質
procrastination,keeping on putting off        ,耽擱
prodigal,wasteful reckless with money        ,浪費者浪費的 揮霍的 放蕩的
prodigious,enormous wonderful          ,很大的 驚人的 異常的
profane,worldly having contempt for God       ,世俗的 不敬神的 褻瀆的褻瀆 玷污
profligacy,shameless immorality        ,放蕩 不檢點 浪費
profligate,wasteful prodigal licentious extravagant        ,放蕩的 不檢點的 浪費的放蕩者 享樂者
profundity,depth           ,深 深度 深奧 深刻 深厚
profuse,abundant/lavish         ,很多的 豐富的 浪費的 慷慨的
proliferate,grow reproduce by rapid multification       ,增殖 激增 擴散使激增
prolix,tiring because too long        ,冗長的 說話羅唆的
prone,prostrate inclined to (undesirable things)       ,傾斜的 有…傾向的 易於…的
propagation,increasing the number spreading extending       ,增殖 繁殖 廣傳
propinquity,nearness in time or place affinity of nature    ,接近 親近 類似
propitiatory,conciliatory appeasing mitigating         ,安撫的;和解的
propitious,auspicious presenting favorable circumstances        ,順利的 適合的 吉祥的 慈悲的
prosaic,everyday mundane commonplace trite pedestrian       ,散文的 散文體的 散文性的
proscribe,denounce as dangerous         ,剝奪人權;放逐;排斥
...
pry,get smth inquire too curiously       ,杠杆 窺探 好奇者打聽 窺探橇 用杠杆撬開
pucker,wrinkle         ,折疊皺紋
pugnacious,fond of in the habit of fighting     ,好鬥的
puissance,strength         ,力 勢 權力
punctilious,precise paying attention to trivialities       ,精密細心的 一絲不苟的 拘泥形式的
pundit,pedant authority on a subject       ,學者 梵學者 博學的人 權威
pungency,sharpness stinging quality         ,苦痛 辛辣 刺激
purvey,provide supply          ,供給 供應
pusillanimous,cowardly craven          ,無氣力的 膽怯的 優柔寡斷的
putrefaction,becoming rotten        ,腐敗 腐敗物
pyre,large pile of wood for burning      ,火葬用的柴堆
quack,person dishonestly claiming to smth       ,鴨叫聲 庸醫 冒充內行之人庸醫的嘎嘎叫 當庸醫 誇大廣告
quaff,drink deeply          ,一口氣喝幹 大口地喝一飲而盡 痛飲
quail,lose courage turn frightened        ,鵪鶉膽怯 畏縮
qualm,feeling of doubt temporary feeling of sickness     ,暈眩 不安 疑慮
quandary,state of doubt or perplexity     ,窘境 困惑 左右為難
quell,suppress subdue          ,壓制 平息 減輕
quibble,try to avoid by sophistication       ,遁辭 謬論 雙關話推託 詭辯 說模棱兩可的話 說俏皮話對…詭辯
quiescence,state of being passive/motionless      ,靜止 不活動 寂靜
quiescent,at rest dormant torpid        ,靜止的 不活動的 寂靜的
quirk,habit or action peculiar to smb or smth    ,雙關語 俏皮話 警句
quixotic,generous unselfish          ,吉訶德式的;狂想家的
quotidian,banal everyday          ,每日的 每日發作的 司空見慣的 平凡的每日熱
rabble,mob crowd the lower classes of populace     ,烏合之眾 起哄的群眾 下層社會 撥火棍聚眾鬧事 用撥火棍攪動
raconteur,person who tells anecdotes        ,善談者;健談者
raffish,low vulgar base tawdry        ,名譽不好的 無賴的 卑鄙的 艷俗的
ramify,to be divided or subdivided to branch out    ,(使)分枝 (使)分叉 (使)成網狀
rancorous,feeling bitterness spitefulness         ,深恨的 懷惡意的
rant,use extravagant language         ,咆哮 激昂地說咆哮 激昂的演說
rapacious,greedy (esp for money)        ,強奪的 貪欲的 貪婪的
rarefy,to make thin to make less dense to purify or refine ,使稀少 使稀薄 使純化變稀少 變稀薄
rave,act with excessive enthusiasm      ,狂吼 狂暴憤怒地說 叫嚷 咆哮
reactionary,opposing progress          ,反動者 反動主義者反動的 反動主義的 反對改革的
rebuff,snub           ,斷然拒絕 嚴厲拒絕 漠不關心嚴厲拒絕
recalcitrant,disobedient           ,反抗的 反對的 頑強的反抗的人 頑強者
recant,take back as being FALSE give up     ,宣佈放棄放棄信仰 撤消聲明 公開認錯
recast,cast or fashion anew        ,重鑄 重作 改造重鑄 改換角色
recidivism,relapse into antisocial or criminal behavior      ,累犯
reciprocity,granting of privileges in return for similar     ,相互性 相互作用 互惠主義
...
regicide,crime of killing a king       ,弒君 大逆 大逆者
reiterate,say or do again several times      ,反復地說 重申 反復地做
rejuvenation,becoming young in nature or appearance      ,返老還童;回春
relapse,fall back again         ,復舊 故態復萌 再發 惡化故態復萌 再陷邪道 再度墮落
remonstrate,to protest object         ,表示異議 抗議 責備抗議地說
render,deliver provide represent         ,報答 歸還 匯報 提出 放棄 反映 表示 表達 表演 致使 執行
renovate,restore smth to better condition       ,更新 革新 刷新 修復 恢復
renowned,celebrated famous          ,著名的 聞名的 有名望的
repast,meal           ,餐 食量 就餐設宴 就餐
repel,refuse to accept/cause dislike      ,逐退 抵制 使厭惡 抗反抗 擊退
repine,at be discontented with        ,抱怨 發牢騷 鳴不平 向往
reproach,scold upbraid          ,責備 恥辱責備 申斥 使丟臉
reprobate,person hardened in sin one devoid of decency    ,墮落的人 惡棍 被神遺棄的人墮落的 邪惡的斥責 非難 拒絕
repudiate,disown refuse to accept or pay      ,離婚 拋棄 拒絕 拒付 拒絕履行
repulsive,causing a feeling of disgust       ,逐退的 可惡的 冷淡的 排斥的
requite,repay give in return        ,報答 報酬 還禮
...
sagacious,having sound judgment perceptive wise like a sage    ,睿智的 聰明的 賢明的
salacious,obscene           ,好色的 猥褻的 黃色的
salubrious,healthful           ,有益健康的 清爽的 健康的
salutary,remedial wholesome causing improvement        ,有益的 有用的 有益健康的
...
savant,person of great learning        ,學者 博學者 專家
savor,taste flavor smth         ,滋味 氣味 食欲有…的滋味加調味品於 使有風味 嘗到
sawdust,tiny bits of wood        ,鋸屑
scabbard,sheath for the blade        ,鞘放入鞘內 裝鞘
scent,smell (esp pleasant)         ,氣味 香味 香水 蹤跡 臭跡 痕跡 線索 嗅覺聞出 嗅 發覺
scorch,become discolored/dry up/go at high speed    ,燒焦 枯黃燒焦 拷焦 (使)枯萎 諷刺
scribble,write hastily          ,潦草的寫法 潦草寫成的東西 雜文潦草地書寫 亂寫 濫寫
scurvy,mean contemptible          ,下流的 卑鄙的 無禮的壞血病
secular,material (not spiritual) living outside monasteries      ,牧師 俗人世俗的 現世的 不朽的 長期的
...
serration,having a toothed edge        ,鋸齒狀 鋸齒狀突起
...
shrill,sharp piercing          ,尖銳的聲音尖銳的 刺耳的用尖銳的聲音說發出刺耳聲
shun,keep away from avoid        ,避開 規避 避免
shunt,send from one track to another lay aside evade discussion  ,使轉軌 使分流 改變 推延轉向一邊 轉軌 往返轉軌 分流
sidestep,step to one side        ,橫跨的一步 台階橫跨一步躲避 回避回避問題 躲避打擊
simper,(give a) silly/self-conscious smile      ,假笑 傻笑 癡笑假笑 傻笑 癡笑假笑著說
sinuous,winding undulating serpentine         ,彎彎曲曲的 迂回的 乖僻的
skiff,small boat          ,小艇 輕舟 小型帆船
skit,short piece of humorous writing       ,諷刺文 戲文 小喜劇
slack,sluggish dull not tight        ,鬆弛 靜止 淡季 閑散 家常褲鬆弛的 不流暢的 疏忽的 懶散的 無力的
slake,to assuage to satisfy allay       ,消除 平息 熄滅
slate,king of blue-grey stone propose criticize      ,石板石板色的鋪石板 責罵 痛打
sluggard,lazy slow-moving person         ,偷懶者 遊手好閑的人 懶鬼
slur,join sounds/words (indistinct)       ,連音符 誹謗 恥辱 印刷模糊草率地看過 忽略 含糊地念模糊不清
smolder,burn slowly without flame      ,悶燒 鬱積悶燒
...
sordid,wretched comfortless contemptible         ,骯臟的 不幹淨的 卑鄙的 惡劣的 可憐的 暗淡的
spear,weapon with a metal point on a long shaft   ,矛 槍 持矛者用矛刺刺 戳父系的
...
stickler,person who insists on importance of smth     ,好挑剔的人;拘泥的人
stigma,mark of shame or disgrace       ,恥辱 汙名 烙印
stigmatize,describe smb scornfully         ,打烙印 誣蔑
sting,smth sharp          ,刺 刺痛 刺激 諷刺刺 刺痛 刺激 使苦惱刺 刺痛
stingy,spending using unwillingly         ,小氣的 吝嗇的 缺乏的 有刺的
stint,to be thrifty to set limits      ,節省 限制 停止節約吝惜 節約 限制
stipple,paint with dots       ,點刻法 點畫 點彩點刻 畫點畫 點彩
stipulate,state or put forward as a necessary condition    ,規定 保証
stolid,showing no emotion impassive        ,遲鈍的 神經麻木的
stray,wander lose one's way        ,走失的家畜 浪子迷途的 偶然的迷路 彷徨 流浪
streak,long thin move very fast       ,條理 斑紋 傾向加條紋變成條紋 飛跑
striated,striped grooved or banded        ,有條紋的 有條痕的 有線紋的
stride,walk with long steps        ,大步 一跨步 進步邁大步走 跨過 跨
strut,a supporting bar         ,高視闊步 支柱 抗壓材趾高氣揚地走 腫脹用支柱支撐 炫耀
stygian,hence dark gloomy         ,地獄的;陰森森的;黑暗的
stymie,to hinder obstruct or block       ,[高爾夫] 妨礙球;妨礙;困境
subdue,overcome bring under control        ,使服從 壓制 減弱 抑制 克制
sublime,extreme astounding          ,壯觀的 卓越的提高 (使)變高尚 (使)純化 (使)升華莊嚴 崇高
submerge,put under water liquid sink out of sight    ,使浸水 使陷入 淹沒潛入水中
suborn,induce by bribery or smth to commit perjury    ,使作偽誓 唆使 慫恿 收買
subpoena,written order requiring a person to appear in a low court ,傳票傳審 喚審
substantiation,giving facts to support (statement)     ,實體化 証實 証明
subsume,include under a rule        ,包容;包含;包括
succor,assistance relief in time of distress      ,救援 援助者救援 援助
suffice,be enough          ,足夠 有能力滿足
suffocate,cause or have difficulty in breathing    ,使窒息 噎住 悶熄悶死 窒息 受阻
sully,to be stained or discredited       ,沾汙 弄臟汙點 臟汙
summarily,briefly without delay         ,概要地 概略地 立刻
sumptuous,magnificent           ,奢侈的 華麗的
sundry,various miscellaneous separate         ,種種 各種各樣的 繁雜的
supercilious,disdainful characterized by haughty scorn       ,傲慢的 自大的 目空一切的
superfluous,more then is needed or wanted      ,多餘的 過剩的
superimpose,put smth on the top       ,重疊;加上去;雙重
supersede,take the place of        ,代替 取代 接替
supine,lying on the back slow to act passive    ,仰臥的 掌心向上的 懶散的
suppliant,asking humbly beseeching         ,懇求的 哀求的 哀求性的懇求者 哀求者
supplicate,make a humble petition to       ,懇求 哀求 懇請
suppress,prevent from being known put an end to    ,鎮壓 使止住 禁止 抑制 查禁
surcharge,additional load/charge        ,裝載過多 超載 追加罰款 額外費使裝載過多 追加罰款
surfeit,satiate feed to fulness or to excess     ,過食 過度 惡心使膩 使沈溺於飲食過度
susceptibility,sensitiveness           ,感受性 感情
swerve,change direction suddenly       ,轉向 彎曲 背離突然轉向 轉彎 背離使突然轉向 使轉彎 使背離
sycophant,person who flatter to the rich and powerful    ,奉承者 諂媚者 追隨者拍馬的 奉承的
synopsis,summary or outline         ,概要 摘要 大意
taciturn,untalkative silent          ,沈默寡言的 不太說話的 無言的
tadpole,form of a frog when it leaves the egg ,蝌蚪
talon,claw of a bird of prey      ,爪 如爪的手 魔爪 鴿胸雕花
tamp,tap or drive down by repeated light blows    ,用粘土填塞 搗固 夯實搗棒 夯
tamper,interfere with          ,幹預 玩弄 賄賂 損害 削弱 竄改竄改搗棒 夯 填塞者
tangential,suddenly changeable          ,切線的 相切的 正切的 離題的 扯遠的 膚淺的
tarnish,lost brightness          ,晦暗 玷污 汙點使失去光澤 玷污失去光澤 被玷污
tassel,bunch of threads       ,流蘇 纓加纓於 摘下…穗須長出穗狀雄花
taunt,contemptuous reproach hurtful remark        ,辱罵 嘲弄嘲弄 奚落很高的
taut,tightly stretched          ,拉緊的 整潔的 緊張的
tautology,a repetition a redundancy        ,同義反復 重復
tawdry,cheap gaudy showy tacky        ,廉價而俗麗的 非常華麗的廉價而俗麗之物
teetotal,oppose to alcohol         ,絕對禁酒的 完全的 絕對的絕對禁酒主義
temerity,boldness brashness intrepidness         ,鹵莽 蠻勇
temperance,abstinence from alcohol self-control moderation       ,溫暖的 溫和的 有節制的
temperate,showing self-control          ,有節制的 適度的 溫和的 溫帶的
tenacity,firmness persistency adhesiveness tending to hang on     ,固執 不屈不撓 頑固 堅韌
tenuous,insubstantial flimsy weak         ,稀薄的 微細的 纖細的 脆弱的
tepid,lukewarm         ,微溫的 溫熱的 不太熱心的
terse,brief and to the point       ,簡潔的 扼要的
testiness,witness/evidence         ,易怒 暴躁
thrift,care economy thriving prosperous        ,節約 繁榮
thwart,obstruct/frustrate         ,橫放的反對 阻礙 橫過橫過
timid,shy easily frightened         ,膽小的 羞怯的
timorous,fearful timid afraid         ,膽怯的 膽小的 羞怯的
toady,obsequious flatterer        ,諂媚者 拍馬屁的人諂媚 拍馬屁
tonic,smth giving strength or energy       ,補藥 (音樂)主調音或基音滋補的 聲調的 使精神振作的
topple,be unsteady and overturn        ,推翻 顛覆倒塌 搖搖欲墜
torment,severe pain or suffering        ,苦痛 拷問使苦惱 攪動 歪曲 拷問
torpid,sleeping sluggish lethargic dormant        ,麻痺的 遲緩的 遲鈍的 蟄伏的
torque,twisting force causing rotation      ,轉力矩 項鏈;&(使)沿軸轉動
tortuous,devious/not straightforward        ,扭曲的 彎曲的 羅唆的 欺騙的
tout,person who worries others to buy smth to use his service ,招徠顧客 死乞白賴地勸誘招徠 刺探…情報兜售者 偵查者
tractable,easily controlled or guided        ,易於管教的
transgress,break go beyond (a limit)       ,違反 犯罪 逸出越界 違法
transient,temporary fleeting          ,暫態 短期居留者 侯鳥 瞬變值短暫的 易變的 瞬變的 路過的
transitory,brief           ,暫時的 短暫的 曇花一現的
travesty,parody/imitation         ,滑稽化的作品 漫畫 滑稽模仿使滑稽化 歪曲
trenchant,forceful effective vigorous extremely perceptive incisive      ,銳利的 尖刻的 苛刻的 有力的 分明的 清晰的
trepidation,alarm excited state of mind       ,恐懼 驚惶 憂慮
trickle,flow in drops       ,滴 細流滴流 細細地流使滴 使細流
trifling,unimportant           ,些許的 不足道的 不足取的
trite,not new          ,平庸的 陳腐的 平凡的 用壞的
truce,(agreement) stop of fighting for a time   ,停戰 休止停戰 休止以休戰結束
truculence,aggressiveness ferocity          ,野蠻 粗野 殘酷
trudge,walk heavily          ,沈重的步伐 長途跋涉沈重地走 蹣跚地走跋涉
turbid,muddy having the sediment stirred up      ,混濁的 泥水的 混亂的 霧重的
turbulence,being uncontrolled violent         ,喧囂 狂暴 騷亂
turgid,excessively ornate swollen or bloated       ,腫的 浮誇的
turmoil,trouble disturbance          ,騷動 混亂
turpitude,wickedness shamefulness          ,奸惡 卑鄙
turquoise,greenish-blue precious stone       ,土耳其玉 藍玉
tyro,tiro beginner          ,初學者 生手 新手
ubiquitous,present everywhere        ,到處存在的 遍在的
ulterior,situated beyond          ,在那邊的 將來的 隱蔽的
umbrage,offense resentment          ,不快 憤怒 陰影 樹蔭 懷疑
uncouth,rough awkward          ,粗俗的 怪異的
underbid,make a lower bid then smb else     ,出較低的價錢 投標低於他人 以低價提供喊價過低 叫牌過低
undermine,weaken gradually at the base make smth under    ,漸漸破壞 挖掘地基 暗地�堹}壞
undulate,to move in wavelike fashion fluctuate      ,波動的 起伏的波動 起伏 呈波浪形使起伏 使波動
unearth,discover and bring to light     ,發掘 掘出 從洞中趕出 揭露 發現
unencumbered,easy-going trifle          ,無拘無束
unfeigned,not pretended sincere         ,不虛偽的 真實的 誠實的
unscathed,unharmed unhurt          ,沒有受傷的 未受傷的 未受傷的
untoward,unfortunate inconvenient          ,麻煩的 困難的 不幸的
upbraid,scold reproach          ,譴責 責罵 申斥
urbane,elegant refined in manners        ,彬彬有禮的
vacillation,being uncertain hesitating         ,遊移不定 躊躇 不果斷
vagary,strange act or idea        ,奇特 好奇 奇特行為 奇想
vain,without use result conceited        ,徒勞的 徒然的 無效的 空虛的 自負的
valiant,brave           ,英勇的勇敢的人
valorous,brave           ,勇敢的 勇武的 剛勇的
vanquish,conquer           ,打敗 征服 克服
veer,change direction          ,轉向使轉向 放出(錨)轉向 方向的轉變
venal,ready to do smth dishonest       ,可收買的 貪汙的 為金錢而做的
veneer,surface appearance covering the TRUE nature      ,膠合板 飾面 外表鑲飾 膠合 虛飾
veneration,regard with deep respect        ,尊敬 崇敬 崇拜
veracity,truth           ,說真實話 老實 誠實
verdant,fresh and green       ,翠綠的 青翠的 生疏的 不老練的
verisimilitude,appearing TRUE or real        ,好象真實 似真 逼真
veritable,real rightly named         ,真實的 確實的 真的
verve,spirit vigor enthusiasm         ,氣魄 神韻 活力
vestige,trace or sign       ,遺跡 痕跡 殘餘 絲毫 退化的器官
...
visceral,of the internal organs of the body     ,內臟的
viscous,sticky/semi-fluid         ,粘的 有粘性的 粘性的
...
waft,scent waving movement carry lightly through      ,吹送 使飄蕩飄蕩吹送 飄蕩
wag,merry person          ,搖擺 搖動 饒舌擺動 喋喋不休搖擺 小丑
...
var myData = $.csv.toObjects(masterCSV);
var myMap = new Map();
for (let i = 0; i < myData.length; i++) {
	myMap.set(myData[i]["word"],myData[i]["meaning"]);
	
}

var myMap2 = new Map();
for (let i = 0; i < myData.length; i++) {
	myMap2.set(myData[i]["word"],myData[i]["ch_meaning"]);
...
function generateList(lettersToInclude, requiredLetters) {
	...
	// });
	myData.forEach((word)=> {
		if(!contains(word["word"].toLowerCase(), excludes) && contains(word["word"], requiredLetters.split(''))){
